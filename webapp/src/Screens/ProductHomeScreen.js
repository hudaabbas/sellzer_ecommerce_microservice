            ...
            <div>
                ...
                <div className="wrap">
                    <div className="row">
                        ...
                        <div className="column">
                            <Link to="/add-product/" className="toggleButton">  Post A New Product  </Link>
                        </div>
                    </div>
                </div>
                        ...
                        product =>
                            <li>
                                <div className="product">
                                    <Link to={'product-home/' +product.catalogId}></Link>
                                    <img className="product-image" src={product.imageId} alt="product"></img>
                                    <div className="product-name">
                                        <Link to={product.catalogId}>{product.catalogName}</Link>
